...
(function(Opal) {
  ...
  (function($base, $super) {
    ...
    def.parsed = nil;
    Opal.defn(self, '$initialize', TMP_2 = function ːinitialize(part) {
      var $a, $b, TMP_1, $c, $d, self = this, notes = nil, chord_modifiers = nil, done = nil, i = nil, c = nil, t1 = nil, t2 = nil, chord = nil;

      notes = ($a = ($b = "A".$ord().$upto("G".$ord()).$to_a()).$map, $a.$$p = (TMP_1 = function(x){var self = TMP_1.$$s || this;
if (x == null) x = nil;
      return x.$chr()}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1), $a).call($b);
      chord_modifiers = $rb_plus(["9", "b", "-", "6", "#", "b", "o", "a", "l", "t", "m", "1", "3", "5", "7", "/", "^"], notes);
      self.parsed = [];
      done = false;
      i = 0;
      while ((($c = $rb_lt(i, part.$size())) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
      c = part['$[]'](i);
      if (c['$==']("{")) {
        self.parsed['$<<'](["repeat_start"])
      } else if (c['$==']("}")) {
        while ((($d = ["}", " "]['$include?'](c)) !== nil && $d != null && (!$d.$$is_boolean || $d == true))) {
        i = $rb_plus(i, 1);
        c = part['$[]'](i);
        ...
        i = $rb_plus(i, 1);
        t2 = part['$[]'](i);
        self.parsed['$<<'](["tempo", t1, t2]);
      } else if (c['$==']("N")) {
        i = $rb_plus(i, 1);
        t1 = part['$[]'](i);
        self.parsed['$<<'](["start_part_end", t1]);
      } else if ((($c = notes['$include?'](c)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
        chord = c;
        c = nil;
        while ((($d = ($rb_plus([nil], chord_modifiers))['$include?'](c)) !== nil && $d != null && (!$d.$$is_boolean || $d == true))) {
        i = $rb_plus(i, 1);
        c = part['$[]'](i);
        if ((($d = chord_modifiers['$include?'](c)) !== nil && $d != null && (!$d.$$is_boolean || $d == true))) {
          chord = $rb_plus(chord, c)
          } else {
          i = $rb_minus(i, 1)
        };};
        self.parsed['$<<'](["chord", chord]);
      } else if ((($c = [","]['$include?'](c)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
        self.parsed['$<<'](["coma"])
      } else if ((($c = [" "]['$include?'](c)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
        if ((($c = done['$!']()) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          self.parsed['$<<'](["space"])}
      } else if (c['$==']("Z")) {
        done = true
        } else {
        self.parsed['$<<'](["unknown", c])
      };
      i = $rb_plus(i, 1);};
    }, TMP_2.$$arity = 1);

    return (Opal.defn(self, '$run', TMP_4 = function ːrun() {
      var $a, $b, TMP_3, self = this, str = nil;

      str = "";
      self.$run_start();
      ($a = ($b = self.parsed).$each, $a.$$p = (TMP_3 = function(item){var self = TMP_3.$$s || this, $c;
if (item == null) item = nil;
      if ((($c = self['$respond_to?'](item['$[]'](0))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          return str = $rb_plus(str, ($c = self).$send.apply($c, [item['$[]'](0)].concat(Opal.to_a(item['$[]']($range(1, -1, false))))))
          } else {
          return nil
        }}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3), $a).call($b);
      return str;
    }, TMP_4.$$arity = 0), nil) && 'run';
  })($scope.base, null);
  return (function($base, $super) {
    function $MMAParser(){};
    ...
    Opal.defn(self, '$repeat_end', TMP_9 = function ːrepeat_end() {
      ...
      self.first_chord_of_the_bar = true;
      if ((($a = self.in_repeat_part) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$add_up_bar_count', TMP_11 = function ːadd_up_bar_count() {
      ...
      str = "";
      if ((($a = self.first_chord_of_the_bar) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        str = "\n" + (self.bar_count) + " "};
